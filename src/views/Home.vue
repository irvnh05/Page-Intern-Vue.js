...
<style type="text/css">
  ...
  *,
  ...
  .bg-secondary {
    ...
    background-color: rgba(241, 24, 128, var(--bg-opacity))
  }
  ...
  .border-secondary {
    --border-opacity: 1;
    border-color: #f11880;
    border-color: rgba(241, 24, 128, var(--border-opacity))
  }
 ...
 .h-28 {
  ...
  .text-secondary {
    --text-opacity: 1;
    color: #f11880;
    color: rgba(241, 24, 128, var(--text-opacity))
  }
...
.splide-cs{
  ...
  .bg-gray-800-opacity {
    background-color: rgba(45, 55, 72, .31373)
  }
